...
clearance---only faster detection and more recovered evidence. A Chicago district-level
study finds detection even slowed dispatch and lowered arrest probability (Topper \&
Ferrazares, 2024), and a 2026 meta-analysis of 44 estimates across eight studies pools to a
null relative incidence-rate ratio of $1.02$ (95\% CI $[0.90, 1.16]$; Huff, Dunlap, \&
Pearson, 2026). The one channel with a credible claim to benefit is medical: a boundary
