...
of the plain PPML's weighting. Second, non-fatal gunshot injuries, a four-times-larger
sample, yield $\beta = +7.51$ under OLS ($p = 0.009$) and an even starker correction: every
count model flips the point estimate \emph{below} one and is null (IRRs $0.84$--$0.92$, $p
\geq 0.23$; Appendix~\ref{app:supporting}, Table~\ref{tab:nfs}). Third, the identical
