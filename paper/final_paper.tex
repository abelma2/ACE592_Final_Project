...
(Figure~\ref{fig:etwfe}). The right tool removes the last escape hatch---the count-model
...
removal effect is null (Poisson IRR $0.91$, 95\% CI $[0.54, 1.52]$). The post window is also
